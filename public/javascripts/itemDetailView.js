...
var itemDetailView = {
    ...
    displayRuns: function () {
        ...
        $("#runs").append("<h2>" + "Run History" + "</h2>" +
                          "<div class=\"col-sm-12\">" + "<b>" + "<div class=\"col-sm-1\">" + "Run ID" + "</div>" + "<div class=\"col-sm-1\">" + "Alt ID" + "</div>" + "<div class=\"col-sm-2\">" + "Location" + "</div>" + "<div class=\"col-sm-2\">" + "Initial Quantity" + "</div>" + "<div class=\"col-sm-2\">" + "Quantity Available" + "</div>" + "<div class=\"col-sm-2\">" + "Quantity Reserved" + "</div>" + "<div class=\"col-sm-1\">" + "Color" + "</div>" + "<div class=\"col-sm-1\">" + "Date Created" + "</div>" + "</b>" + "</div>");
        ...
        for (var i = this.runs.length - 1; i >= 0; --i) {
            ...
            if (displayColor % 2 == 0) {
                $("#runs").append("<div style=\"background:lightgray\" class=\"col-sm-12\">" + "<div class=\"col-sm-1\">" + run.RunID + "</div>" + "<div class=\"col-sm-1\">" + run.AltID + "</div>" + "<div class=\"col-sm-2\">" + run.Location + "</div>" + "<div class=\"col-sm-2\">" + run.InitialQuantity + "</div>" + "<div class=\"col-sm-2\">" + run.QuantityAvailable + "</div>" + "<div class=\"col-sm-2\">" + run.QuantityReserved + "</div>" + "<div class=\"col-sm-1\">" + "Color" + "</div>" + "<div class=\"col-sm-1\">" + dateRegex.exec(run.DateCreated) + "</div>" + "</div>");
                ++displayColor;
            } else {
                $("#runs").append("<div class=\"col-sm-12\">" + "<div class=\"col-sm-1\">" + run.RunID + "</div>" + "<div class=\"col-sm-1\">" + run.AltID + "</div>" + "<div class=\"col-sm-2\">" + run.Location + "</div>" + "<div class=\"col-sm-2\">" + run.InitialQuantity + "</div>" + "<div class=\"col-sm-2\">" + run.QuantityAvailable + "</div>" + "<div class=\"col-sm-2\">" + run.QuantityReserved + "</div>" + "<div class=\"col-sm-1\">" + "Color" + "</div>" + "<div class=\"col-sm-1\">" + dateRegex.exec(run.DateCreated) + "</div>" + "</div>");
                ++displayColor;
            }
        }
    },
